...
import { JSON_URL } from "./utils/constants.js";
...
// Browsers load same-origin API data to avoid CORS failures from
// api.overpicker.com. Static deploys publish these files; Laravel proxies them.
const API_URL = "api/";
